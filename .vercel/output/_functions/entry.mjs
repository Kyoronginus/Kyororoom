import { C as ActionNotFoundError, D as ClientAddressNotAvailable, E as CacheNotEnabled, H as InvalidGetStaticPathsEntry, I as GetStaticPathsExpectedParams, J as MiddlewareNoDataOrNextCalled, K as LocalsNotAnObject, L as GetStaticPathsInvalidRouteParam, P as ForbiddenRewrite, R as GetStaticPathsRequired, S as matchPattern, St as isAstroError, T as AstroResponseHeadersReassigned, U as InvalidGetStaticPathsReturn, Y as MiddlewareNotAResponse, _ as trimSlashes, a as fileExtension, at as NoMatchingStaticPathFound, bt as i18nNoLocaleFoundInPath, ct as PrerenderClientAddressNotAvailable, f as removeLeadingForwardSlash, ft as ReservedSlotName, g as stripRequestBase, h as slash, ht as StaticClientAddressNotAvailable, i as collapseDuplicateTrailingSlashes, l as joinPaths, lt as PrerenderDynamicEndpointPathCollide, m as removeTrailingForwardSlash, mt as RewriteWithBodyUsed, n as collapseDuplicateLeadingSlashes, nt as NoManifestAvailable, o as hasFileExtension, pt as ResponseSentError, q as LocalsReassigned, r as collapseDuplicateSlashes, s as isInternalPath, st as PageNumberParamNotFound, t as appendForwardSlash, u as prependForwardSlash, w as ActionsReturnedInvalidDataError, xt as AstroError } from "./chunks/path_CvSUBqhX.mjs";
import { A as REROUTABLE_STATUS_CODES, D as ASTRO_GENERATOR, E as ASTRO_ERROR_HEADER, F as decodeKey, I as decryptString, L as generateCspDigest, M as fetchStateSymbol, N as originPathnameSymbol, O as DEFAULT_404_COMPONENT, P as responseSentSymbol$1, S as renderEndpoint, T as isRoute500, _ as normalizeCspResourceEntry, a as renderJSX, b as isAstroComponentFactory, c as createSlotValueFromString, d as renderTemplate, g as isRenderInstruction, i as renderPage, j as clientAddressSymbol, k as REDIRECT_STATUS_CODES, l as renderSlotToString, o as renderComponent, s as chunkToString, u as isRenderTemplateResult, v as pushDirective, w as isRoute404 } from "./chunks/server_C82mvBIY.mjs";
...
var middlewareSecret = "5f9fd341-c8e7-4af5-a0ae-206069295e0c";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/art.ts",
			"pathname": "/api/art",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/patreon/members",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/patreon\\/members\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/patreon/members.ts",
			"pathname": "/api/patreon/members",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/patreon/posts",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/patreon\\/posts\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/patreon/posts.ts",
			"pathname": "/api/patreon/posts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/spotify.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/ticker.ts",
			"pathname": "/api/ticker",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/views.ts",
			"pathname": "/api/views",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/art-trades.astro",
			"pathname": "/art-trades",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/works/index.astro",
			"pathname": "/works",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["...id"],
			"component": "src/pages/works/[...id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_Beq9ZaFu.mjs");
var _page1 = () => import("./chunks/art_DUblEWwk.mjs");
var _page2 = () => import("./chunks/members_CUwuJBY5.mjs");
var _page3 = () => import("./chunks/posts_DEQqsQHV.mjs");
var _page4 = () => import("./chunks/spotify_D0WRpyEL.mjs");
var _page5 = () => import("./chunks/ticker_TMa53A0e.mjs");
var _page6 = () => import("./chunks/views_DfxD5fV0.mjs");
var _page7 = () => import("./chunks/art-trades_BN1uD9et.mjs");
var _page8 = () => import("./chunks/index_D-D5VN7D.mjs");
var _page9 = () => import("./chunks/_.._BOmMM3lO.mjs");
var _page10 = () => import("./chunks/index_DB0Peqpz.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/art.ts", _page1],
	["src/pages/api/patreon/members.ts", _page2],
	["src/pages/api/patreon/posts.ts", _page3],
	["src/pages/api/spotify.ts", _page4],
	["src/pages/api/ticker.ts", _page5],
	["src/pages/api/views.ts", _page6],
	["src/pages/art-trades.astro", _page7],
	["src/pages/works/index.astro", _page8],
	["src/pages/works/[...id].astro", _page9],
	["src/pages/index.astro", _page10]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/tohru/Documents/Programming/Kyororoom/","cacheDir":"file:///Users/tohru/Documents/Programming/Kyororoom/node_modules/.astro/","outDir":"file:///Users/tohru/Documents/Programming/Kyororoom/dist/","srcDir":"file:///Users/tohru/Documents/Programming/Kyororoom/src/","publicDir":"file:///Users/tohru/Documents/Programming/Kyororoom/public/","buildClientDir":"file:///Users/tohru/Documents/Programming/Kyororoom/dist/client/","buildServerDir":"file:///Users/tohru/Documents/Programming/Kyororoom/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/art","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/art\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"art","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/art.ts","pathname":"/api/art","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/patreon/members","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/patreon\\/members\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"patreon","dynamic":false,"spread":false}],[{"content":"members","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/patreon/members.ts","pathname":"/api/patreon/members","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/patreon/posts","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/patreon\\/posts\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"patreon","dynamic":false,"spread":false}],[{"content":"posts","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/patreon/posts.ts","pathname":"/api/patreon/posts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/spotify","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/spotify\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"spotify","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/spotify.ts","pathname":"/api/spotify","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/ticker","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/ticker\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"ticker","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/ticker.ts","pathname":"/api/ticker","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/views","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/views\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"views","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/views.ts","pathname":"/api/views","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D4hDNfFG.css"},{"type":"inline","content":".trades-main[data-astro-cid-nteufkqd]{max-width:var(--content-max-width);width:var(--content-width);margin:0 auto;padding:20px 0}.trades-header[data-astro-cid-nteufkqd]{margin-bottom:24px}.page-title[data-astro-cid-nteufkqd]{font-size:var(--section-title-size);margin:.2em 0}.trades-grid[data-astro-cid-nteufkqd]{columns:3 320px;column-gap:16px}.trade-card[data-astro-cid-nteufkqd]{break-inside:avoid;background:#fff;border:1px solid #ccc;margin-bottom:16px;transition:border-color .2s,transform .2s;overflow:hidden}.trade-card[data-astro-cid-nteufkqd]:hover{border-color:#333;transform:translateY(-2px)}.trade-link[data-astro-cid-nteufkqd]{cursor:zoom-in;width:100%;display:block}.trade-img[data-astro-cid-nteufkqd]{width:100%;height:auto;display:block}@media (width<=640px){.trades-grid[data-astro-cid-nteufkqd]{columns:2 150px;column-gap:10px}.trade-card[data-astro-cid-nteufkqd]{margin-bottom:10px}}\n"}],"routeData":{"route":"/art-trades","isIndex":false,"type":"page","pattern":"^\\/art-trades\\/?$","segments":[[{"content":"art-trades","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/art-trades.astro","pathname":"/art-trades","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D4hDNfFG.css"},{"type":"inline","content":".logo[data-astro-cid-bt5j2la3] a[data-astro-cid-bt5j2la3]{color:inherit;text-decoration:none;transition:color .2s}.logo[data-astro-cid-bt5j2la3] a[data-astro-cid-bt5j2la3]:hover{color:#37c13e}.works-page-main[data-astro-cid-bt5j2la3]{flex-direction:column;gap:16px;width:95%;max-width:1200px;margin:30px auto 80px;display:flex}.works-page-header[data-astro-cid-bt5j2la3]{margin-bottom:10px}.page-title[data-astro-cid-bt5j2la3]{letter-spacing:-.02em;color:#111;margin:0;font-size:2.2rem;font-weight:800}@media (width<=768px){.works-page-main[data-astro-cid-bt5j2la3]{margin-top:20px}.page-title[data-astro-cid-bt5j2la3]{font-size:1.8rem}}\n.works-container[data-astro-cid-ovf77dj5]{width:100%;margin-top:10px}.works-filter-bar[data-astro-cid-ovf77dj5]{flex-wrap:wrap;gap:8px;margin-bottom:20px;display:flex}.works-filter-btn[data-astro-cid-ovf77dj5]{letter-spacing:.05em;cursor:pointer;color:#333;background:#fff;border:1px solid #ccc;align-items:center;gap:5px;padding:6px 14px;font-family:inherit;font-size:.85rem;font-weight:700;text-decoration:none;transition:background-color .2s,color .2s,border-color .2s;display:inline-flex}.works-filter-btn[data-astro-cid-ovf77dj5]:hover{color:#fff;background-color:#37c13e;border-color:#37c13e}.works-filter-btn[data-astro-cid-ovf77dj5].active{color:#fff;background-color:#222;border-color:#222}.filter-count[data-astro-cid-ovf77dj5]{opacity:.8;font-size:.75rem}.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(4,1fr);gap:16px;display:grid}.work-card[data-astro-cid-ovf77dj5]{color:inherit;background:#fff;border:1px solid #ccc;flex-direction:column;text-decoration:none;transition:transform .2s,border-color .2s;animation:.3s ease-out cardEntrance;display:flex;overflow:hidden}.work-card[data-astro-cid-ovf77dj5]:hover{border-color:var(--card-accent,#333);transform:translateY(-3px)}.is-hidden[data-astro-cid-ovf77dj5]{display:none!important}.work-image-wrapper[data-astro-cid-ovf77dj5]{aspect-ratio:4/3;background-color:#f0f0f0;width:100%;position:relative;overflow:hidden}.work-thumb[data-astro-cid-ovf77dj5]{object-fit:cover;width:100%;height:100%;transition:transform .35s;display:block}.work-card[data-astro-cid-ovf77dj5]:hover .work-thumb[data-astro-cid-ovf77dj5]{transform:scale(1.05)}.work-card-info[data-astro-cid-ovf77dj5]{background:#fff;border-top:1px solid #eee;flex-direction:column;gap:4px;padding:10px 12px;display:flex}.work-card-title[data-astro-cid-ovf77dj5]{text-overflow:ellipsis;white-space:nowrap;font-size:.95rem;font-weight:700;line-height:1.3;overflow:hidden}.work-card-category[data-astro-cid-ovf77dj5]{color:#888;text-transform:capitalize;font-size:.75rem}.works-empty[data-astro-cid-ovf77dj5]{text-align:center;color:#888;background:#fafafa;border:1px dashed #ccc;margin-top:10px;padding:40px}.view-more[data-astro-cid-ovf77dj5]{text-align:right;margin-top:20px}.view-more[data-astro-cid-ovf77dj5] a[data-astro-cid-ovf77dj5]{color:#333;letter-spacing:.05em;font-size:.9rem;font-weight:700;text-decoration:none;transition:color .2s}.view-more[data-astro-cid-ovf77dj5] a[data-astro-cid-ovf77dj5]:hover{color:#37c13e}@keyframes cardEntrance{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}@media (width<=1024px){.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(3,1fr);gap:14px}}@media (width<=768px){.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(2,1fr);gap:10px}.work-card-title[data-astro-cid-ovf77dj5]{font-size:.85rem}.work-card-info[data-astro-cid-ovf77dj5]{padding:8px}}\n"}],"routeData":{"route":"/works","isIndex":true,"type":"page","pattern":"^\\/works\\/?$","segments":[[{"content":"works","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/works/index.astro","pathname":"/works","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D4hDNfFG.css"},{"type":"inline","content":".logo[data-astro-cid-iwejmkk2] a[data-astro-cid-iwejmkk2]{color:inherit;text-decoration:none;transition:color .2s}.logo[data-astro-cid-iwejmkk2] a[data-astro-cid-iwejmkk2]:hover{color:#37c13e}.detail-main[data-astro-cid-iwejmkk2]{flex-direction:column;gap:28px;width:95%;max-width:1100px;margin:30px auto 80px;display:flex}.artwork-view-container[data-astro-cid-iwejmkk2]{justify-content:center;align-items:center;width:100%;display:flex}.detail-artwork-image[data-astro-cid-iwejmkk2]{object-fit:contain;width:auto;max-width:100%;height:auto;max-height:80vh;margin:0 auto;display:block}.artwork-details-panel[data-astro-cid-iwejmkk2]{background:#fff;border:1px solid #ccc;flex-direction:column;gap:16px;padding:24px 28px;display:flex}.title-category-row[data-astro-cid-iwejmkk2]{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}.artwork-title[data-astro-cid-iwejmkk2]{color:#111;margin:0;font-size:1.8rem;font-weight:700;line-height:1.2}.detail-category-badge[data-astro-cid-iwejmkk2]{letter-spacing:.05em;background:#fafafa;border:1px solid #ccc;padding:4px 10px;font-size:.8rem;font-weight:700}.badge-personal[data-astro-cid-iwejmkk2]{color:#1b8a2e;border-color:#1b8a2e}.badge-commission[data-astro-cid-iwejmkk2]{color:#0b63b6;border-color:#0b63b6}.details-divider[data-astro-cid-iwejmkk2]{border:none;border-top:1px solid #eee;margin:4px 0}.artwork-description-content[data-astro-cid-iwejmkk2]{color:#333;font-size:1rem;line-height:1.7}.artwork-description-content[data-astro-cid-iwejmkk2] p{margin-top:0;margin-bottom:1em}.artwork-description-content[data-astro-cid-iwejmkk2] p:last-child{margin-bottom:0}.artwork-pagination[data-astro-cid-iwejmkk2]{justify-content:space-between;gap:16px;margin-top:10px;display:flex}.pagination-btn[data-astro-cid-iwejmkk2]{color:inherit;background:#fff;border:1px solid #ccc;flex-direction:column;flex:1;gap:8px;max-width:48%;padding:12px;text-decoration:none;transition:border-color .2s,transform .2s,box-shadow .2s;display:flex}.pagination-next[data-astro-cid-iwejmkk2]{text-align:right;align-items:flex-end}.pagination-btn[data-astro-cid-iwejmkk2]:hover{border-color:#333;transform:translateY(-2px);box-shadow:0 4px 12px #0000000f}.pagination-sub[data-astro-cid-iwejmkk2]{color:#888;letter-spacing:.05em;font-size:.75rem;font-weight:700}.pagination-thumb-wrapper[data-astro-cid-iwejmkk2]{aspect-ratio:4/3;background-color:#f0f0f0;border:1px solid #eee;width:100%;max-height:140px;overflow:hidden}.pagination-thumb[data-astro-cid-iwejmkk2]{object-fit:cover;width:100%;height:100%;transition:transform .3s;display:block}.pagination-btn[data-astro-cid-iwejmkk2]:hover .pagination-thumb[data-astro-cid-iwejmkk2]{transform:scale(1.04)}.pagination-placeholder[data-astro-cid-iwejmkk2]{flex:1;max-width:48%}@media (width<=768px){.detail-main[data-astro-cid-iwejmkk2]{gap:20px;margin-top:16px}.artwork-details-panel[data-astro-cid-iwejmkk2]{padding:16px}.artwork-title[data-astro-cid-iwejmkk2]{font-size:1.4rem}.artwork-pagination[data-astro-cid-iwejmkk2]{flex-direction:column}.pagination-btn[data-astro-cid-iwejmkk2]{max-width:100%}.pagination-next[data-astro-cid-iwejmkk2]{text-align:left;align-items:flex-start}.pagination-thumb-wrapper[data-astro-cid-iwejmkk2]{max-height:180px}}\n"}],"routeData":{"route":"/works/[...id]","isIndex":false,"type":"page","pattern":"^\\/works(?:\\/(.*?))?\\/?$","segments":[[{"content":"works","dynamic":false,"spread":false}],[{"content":"...id","dynamic":true,"spread":true}]],"params":["...id"],"component":"src/pages/works/[...id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/global.D4hDNfFG.css"},{"type":"external","src":"_astro/index.CI5WACtP.css"},{"type":"inline","content":".works-container[data-astro-cid-ovf77dj5]{width:100%;margin-top:10px}.works-filter-bar[data-astro-cid-ovf77dj5]{flex-wrap:wrap;gap:8px;margin-bottom:20px;display:flex}.works-filter-btn[data-astro-cid-ovf77dj5]{letter-spacing:.05em;cursor:pointer;color:#333;background:#fff;border:1px solid #ccc;align-items:center;gap:5px;padding:6px 14px;font-family:inherit;font-size:.85rem;font-weight:700;text-decoration:none;transition:background-color .2s,color .2s,border-color .2s;display:inline-flex}.works-filter-btn[data-astro-cid-ovf77dj5]:hover{color:#fff;background-color:#37c13e;border-color:#37c13e}.works-filter-btn[data-astro-cid-ovf77dj5].active{color:#fff;background-color:#222;border-color:#222}.filter-count[data-astro-cid-ovf77dj5]{opacity:.8;font-size:.75rem}.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(4,1fr);gap:16px;display:grid}.work-card[data-astro-cid-ovf77dj5]{color:inherit;background:#fff;border:1px solid #ccc;flex-direction:column;text-decoration:none;transition:transform .2s,border-color .2s;animation:.3s ease-out cardEntrance;display:flex;overflow:hidden}.work-card[data-astro-cid-ovf77dj5]:hover{border-color:var(--card-accent,#333);transform:translateY(-3px)}.is-hidden[data-astro-cid-ovf77dj5]{display:none!important}.work-image-wrapper[data-astro-cid-ovf77dj5]{aspect-ratio:4/3;background-color:#f0f0f0;width:100%;position:relative;overflow:hidden}.work-thumb[data-astro-cid-ovf77dj5]{object-fit:cover;width:100%;height:100%;transition:transform .35s;display:block}.work-card[data-astro-cid-ovf77dj5]:hover .work-thumb[data-astro-cid-ovf77dj5]{transform:scale(1.05)}.work-card-info[data-astro-cid-ovf77dj5]{background:#fff;border-top:1px solid #eee;flex-direction:column;gap:4px;padding:10px 12px;display:flex}.work-card-title[data-astro-cid-ovf77dj5]{text-overflow:ellipsis;white-space:nowrap;font-size:.95rem;font-weight:700;line-height:1.3;overflow:hidden}.work-card-category[data-astro-cid-ovf77dj5]{color:#888;text-transform:capitalize;font-size:.75rem}.works-empty[data-astro-cid-ovf77dj5]{text-align:center;color:#888;background:#fafafa;border:1px dashed #ccc;margin-top:10px;padding:40px}.view-more[data-astro-cid-ovf77dj5]{text-align:right;margin-top:20px}.view-more[data-astro-cid-ovf77dj5] a[data-astro-cid-ovf77dj5]{color:#333;letter-spacing:.05em;font-size:.9rem;font-weight:700;text-decoration:none;transition:color .2s}.view-more[data-astro-cid-ovf77dj5] a[data-astro-cid-ovf77dj5]:hover{color:#37c13e}@keyframes cardEntrance{0%{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}@media (width<=1024px){.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(3,1fr);gap:14px}}@media (width<=768px){.works-grid[data-astro-cid-ovf77dj5]{grid-template-columns:repeat(2,1fr);gap:10px}.work-card-title[data-astro-cid-ovf77dj5]{font-size:.85rem}.work-card-info[data-astro-cid-ovf77dj5]{padding:8px}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/tohru/Documents/Programming/Kyororoom/src/pages/works/[...id].astro",{"propagation":"none","containsHead":true}],["/Users/tohru/Documents/Programming/Kyororoom/src/pages/art-trades.astro",{"propagation":"none","containsHead":true}],["/Users/tohru/Documents/Programming/Kyororoom/src/pages/works/index.astro",{"propagation":"none","containsHead":true}],["/Users/tohru/Documents/Programming/Kyororoom/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/Users/tohru/Documents/Programming/Kyororoom/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/works/[...id]@_@astro":"chunks/_.._BOmMM3lO.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_orQE48a0.mjs","\u0000virtual:astro:get-image":"chunks/_virtual_astro_get-image_wFbMO2ut.mjs","\u0000virtual:astro:page:src/pages/art-trades@_@astro":"chunks/art-trades_BN1uD9et.mjs","\u0000virtual:astro:page:src/pages/api/art@_@ts":"chunks/art_DUblEWwk.mjs","/Users/tohru/Documents/Programming/Kyororoom/.astro/content-assets.mjs":"chunks/content-assets_CIabMQGU.mjs","/Users/tohru/Documents/Programming/Kyororoom/.astro/content-modules.mjs":"chunks/content-modules_I7QRxwaA.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_Beq9ZaFu.mjs","\u0000virtual:astro:page:src/pages/works/index@_@astro":"chunks/index_D-D5VN7D.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DB0Peqpz.mjs","\u0000virtual:astro:page:src/pages/api/patreon/members@_@ts":"chunks/members_CUwuJBY5.mjs","\u0000virtual:astro:page:src/pages/api/patreon/posts@_@ts":"chunks/posts_DEQqsQHV.mjs","/Users/tohru/Documents/Programming/Kyororoom/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BPzLIwfd.mjs","\u0000virtual:astro:page:src/pages/api/spotify@_@ts":"chunks/spotify_D0WRpyEL.mjs","\u0000virtual:astro:page:src/pages/api/ticker@_@ts":"chunks/ticker_TMa53A0e.mjs","\u0000virtual:astro:page:src/pages/api/views@_@ts":"chunks/views_DfxD5fV0.mjs","/Users/tohru/Documents/Programming/Kyororoom/src/components/about/ArtWidget.tsx":"_astro/ArtWidget.DbRYQec-.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/contact/ContactSection.astro?astro&type=script&index=0&lang.ts":"_astro/ContactSection.astro_astro_type_script_index_0_lang.DT6Wb4er.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/about/DiscordWidget.tsx":"_astro/DiscordWidget.CnFsIHRV.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/about/GitHubWidget.tsx":"_astro/GitHubWidget.DB_q6oG2.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/hero/HeroCarousel.tsx":"_astro/HeroCarousel.CvMQ6tHR.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/common/MorphingTopo.tsx":"_astro/MorphingTopo.sYVW2dzZ.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/blog/PatreonBlog.tsx":"_astro/PatreonBlog.BiyRFBLu.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/hero/PatronTicker.tsx":"_astro/PatronTicker.Dfe-yEvE.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/about/SpotifyWidget.tsx":"_astro/SpotifyWidget.D7DQ3xla.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/hero/Ticker.tsx":"_astro/Ticker.BZRxjTJL.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/contact/VisitorCounter.tsx":"_astro/VisitorCounter.ClRTbVJS.js","/Users/tohru/Documents/Programming/Kyororoom/src/components/works/WorksGallery.astro?astro&type=script&index=0&lang.ts":"_astro/WorksGallery.astro_astro_type_script_index_0_lang.ivdzbpqa.js","@astrojs/react/client.js":"_astro/client.XHtoj3W1.js","/Users/tohru/Documents/Programming/Kyororoom/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.BSB5HRJI.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/tohru/Documents/Programming/Kyororoom/src/components/contact/ContactSection.astro?astro&type=script&index=0&lang.ts","var e=document.querySelector(`.commission-panel`),t=document.querySelectorAll(`.comm-lang-btn`);if(e&&t.length){n(localStorage.getItem(`commission_lang`)||`en`),t.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-lang-btn`);t&&(n(t),localStorage.setItem(`commission_lang`,t))})});function n(n){e?.setAttribute(`data-lang`,n),t.forEach(e=>{e.getAttribute(`data-lang-btn`)===n?(e.classList.add(`active`),e.setAttribute(`aria-pressed`,`true`)):(e.classList.remove(`active`),e.setAttribute(`aria-pressed`,`false`))})}}"],["/Users/tohru/Documents/Programming/Kyororoom/src/components/works/WorksGallery.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.querySelectorAll(`.works-filter-bar button.works-filter-btn`),t=document.querySelectorAll(`.work-card`),n=document.getElementById(`works-empty-state`);if(e.length===0)return;function r(r){e.forEach(e=>{let t=(e.dataset.filter||`all`)===r;e.classList.toggle(`active`,t),e.setAttribute(`aria-selected`,t?`true`:`false`)});let i=0;t.forEach(e=>{let t=e.dataset.category;r===`all`||t===r?(e.classList.remove(`is-hidden`),i++):e.classList.add(`is-hidden`)}),n&&(i===0?n.classList.remove(`is-hidden`):n.classList.add(`is-hidden`))}let i=new URLSearchParams(window.location.search).get(`category`);i&&(i===`personal`||i===`commission`)&&r(i),e.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.filter||`all`;r(t);let n=new URL(window.location.href);t===`all`?n.searchParams.delete(`category`):n.searchParams.set(`category`,t),window.history.replaceState({},``,n.toString())})})}e(),document.addEventListener(`astro:page-load`,e);"],["/Users/tohru/Documents/Programming/Kyororoom/src/pages/index.astro?astro&type=script&index=0&lang.ts","function e(){let e=Array.from(document.querySelectorAll(`.nav-links a`));if(!e.length)return;let t=e.map(e=>{let t=e.getAttribute(`href`)||``,n=t.startsWith(`#`)?t.slice(1):``;return{id:n,element:n?document.getElementById(n):null,link:e}}).filter(e=>!!e.element);if(!t.length)return;function n(){let e=window.scrollY,n=window.innerHeight,r=document.documentElement.scrollHeight,i=``,a=t.find(e=>e.id===`contact`),o=a?a.element.getBoundingClientRect():null;e+n>=r-60&&o&&o.top<=n*.5?i=`contact`:t.forEach(({id:e,element:t})=>{let n=t.getBoundingClientRect();n.top<=200&&n.bottom>200&&(i=e)}),t.forEach(({id:e,link:t})=>{e===i?t.classList.add(`active`):t.classList.remove(`active`)})}window.addEventListener(`scroll`,n,{passive:!0}),n()}e(),document.addEventListener(`astro:page-load`,e);"]],"assets":["/favicon.ico","/favicon.svg","/icon.png","/_astro/ArtWidget.DbRYQec-.js","/_astro/DiscordWidget.CnFsIHRV.js","/_astro/GitHubWidget.DB_q6oG2.js","/_astro/HeroCarousel.CvMQ6tHR.js","/_astro/MorphingTopo.sYVW2dzZ.js","/_astro/PatreonBlog.BiyRFBLu.js","/_astro/PatronTicker.Dfe-yEvE.js","/_astro/SpotifyWidget.D7DQ3xla.js","/_astro/Ticker.BZRxjTJL.js","/_astro/VisitorCounter.ClRTbVJS.js","/_astro/client.XHtoj3W1.js","/_astro/jsx-runtime.D7zcSYNz.js","/_astro/react.OrosJ8bI.js","/assets/About/icon.png","/assets/About/icon.webp","/assets/About/oc_monochrome.png","/assets/icons/github.svg","/assets/icons/patreon.svg","/assets/icons/pixel-art.svg","/assets/icons/pixel-code.svg","/assets/icons/pixiv.svg","/assets/icons/x.svg","/assets/contacts/venna_pixel.png","/assets/About/OCs/agamenon-1.png","/assets/About/OCs/agamenon-1.webp","/assets/About/OCs/agnia-1.png","/assets/About/OCs/agnia-1.webp","/assets/About/OCs/venna-1.png","/assets/About/OCs/venna-1.webp","/assets/Hero/Carousel/1.webp","/assets/Hero/Carousel/2.webp","/assets/Hero/Carousel/3.webp","/assets/Hero/Carousel/4.webp","/assets/Hero/Carousel/5.webp","/assets/Hero/Carousel/6.webp","/assets/Hero/Carousel/7.webp","/assets/Hero/Carousel/8.webp","/assets/Hero/Etc/idolized.png","/assets/Hero/Etc/idolized.webp","/assets/Hero/Etc/oekakusa.png","/assets/Hero/Video/Uchinoko Kawaii.gif","/assets/Hero/Video/Uchinoko Kawaii.mp4","/assets/Hero/Video/Uchinoko Kawaii.webp","/assets/Hero/Video/fibonacci.gif","/assets/Hero/Video/fibonacci.webp","/assets/Hero/Video/oekakusa.gif","/assets/Hero/Video/oekakusa.mp4","/assets/Hero/Video/oekakusa.webp","/_astro/IMG_1571.B-p_oUL2.png","/_astro/IMG_20200424_152022.B4zuQSuU.jpg","/_astro/IMG_20200504_171301.Cwag36RY.jpg","/_astro/IMG_20200506_161737.xkFpIgJd.jpg","/_astro/IMG_20200506_161800.BJL_y0ly.jpg","/_astro/IMG_20200524_081317.CfdwqxmG.jpg","/_astro/IMG_20200509_132116.ooAlxpuZ.jpg","/_astro/IMG_20200531_164743.CZfaXCjW.jpg","/_astro/IMG_20200711_105327.CKQDxe9l.jpg","/_astro/IMG_20200606_175200.CcRuok2X.jpg","/_astro/IMG_20200711_123449.4wUNVvxK.jpg","/_astro/IMG_20200711_090626.D0RUTZke.jpg","/_astro/eeccda3ae4f487c04dcb506271e8139be9df71728e3224d777dd94a3fd07c0bb.vVYAfZ9m.png","/_astro/IMG_20200711_190814.C2-U6Cu2.jpg","/_astro/image.BRQcTk4p.png","/_astro/IMG_20200505_190226.D_HTSvM_.jpg","/_astro/image0-4.CFv5acjd.jpg","/_astro/HBc9Cn3bYAAHxIq.CRd8h4jk.jpeg","/_astro/Kyoro2024.TFpPL0H4.png","/_astro/kyoro_happy_birthday2_.G9ej3530.png","/_astro/ff037427dc86a93d.CTDFTK2u.png","/_astro/1.m1lrslap.webp","/_astro/2.BoxUCOHO.webp","/_astro/1.DXwGrNjn.webp","/_astro/2.DwcYI-p8.webp","/_astro/1.CImj1ybo.webp","/_astro/4.CLkBhwES.webp","/_astro/1.ErIRZAUI.webp","/_astro/2.96H4EBPR.webp","/_astro/2.CbuqQahN.png","/_astro/1.BS6BBJC3.png","/_astro/4.gDZaG3z_.png","/_astro/1.WBs-KWHO.png","/_astro/9.97DyQ367.png","/_astro/8.BBfkfDMJ.png","/_astro/3.qDYZfF2V.png","/_astro/5.DNXyv9jv.png","/_astro/7.DJnfG8YC.png","/_astro/2.DyhAuZ58.png","/_astro/3.BxtAwadC.png","/_astro/6.BOHVRE-1.png","/_astro/3.CQld5iBc.png","/_astro/global.D4hDNfFG.css","/_astro/index.CI5WACtP.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"qGYbiBmug+RmKeNBkjlhQf9+1SaoE7vlrxZV1yJP5AA=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/tohru/Documents/Programming/Kyororoom/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/tohru/Documents/Programming/Kyororoom/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "5f9fd341-c8e7-4af5-a0ae-206069295e0c") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
